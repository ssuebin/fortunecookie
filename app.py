...
fortunes = [
    ...
    "내게 있어 삶이란 그런 것 같아. 누군가의 생각 속에 살아있는 것 말이야.",
    "사람은 많으나 생각은 적다. 우리 모두는 서로 전달하고 차용하고 서로 상대의 생각을 훔치기도 하면서 거의 동일한 것을 생각하는 것이다.",
    "자기 이미지에 대한 염려, 그건 어찌할 수 없는 인간의 미숙함 아니겠습니까.",
    "사랑하는 사람의 생각에 비칠 자신의 이미지에 대한 불안한 탐색을 빼고서 사랑을 한다는 게 가능한 일인가?"
]
